...
<template>
  <div class="w-[80px] bg-white flex flex-col items-center h-screen justify-start shadow-md">
    ...
    <div class="gap-y-[14px] flex flex-col">
      ...
      <div
        class="w-[48px] h-[48px] hover:bg-[#EEEBFC] rounded-full cursor-pointer active:scale-90 transition flex justify-center items-center text-[#A09DB1]"
        :class="[route.path === '/stripe' ? 'bg-[#EEEBFC]' : 'hover:bg-[#EEEBFC]']"
        @click="router.push('/stripe')"
      >
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            :class="[route.path === '/stripe' ? 'showIcon' : 'icon']"
            d="M2.75 12C2.75 6.89161 6.89161 2.75 12 2.75C17.1084 2.75 21.25 6.89161 21.25 12C21.25 17.1084 17.1084 21.25 12 21.25C6.89161 21.25 2.75 17.1084 2.75 12ZM12 14H16.5C16.8315 14 17.1495 13.8683 17.3839 13.6339C17.6183 13.3995 17.75 13.0815 17.75 12.75C17.75 12.4185 17.6183 12.1005 17.3839 11.8661C17.1495 11.6317 16.8315 11.5 16.5 11.5H13.25V6C13.25 5.66848 13.1183 5.35054 12.8839 5.11612C12.6495 4.8817 12.3315 4.75 12 4.75C11.6685 4.75 11.3505 4.8817 11.1161 5.11612C10.8817 5.35054 10.75 5.66848 10.75 6V12.75C10.75 13.0815 10.8817 13.3995 11.1161 13.6339C11.3505 13.8683 11.6685 14 12 14Z"
            fill="#A09DB1"
            stroke="#A09DB1"
          />
        </svg>
      ...
      <BaseModal :customHeader="true" :customButtons="true">
        <template #button>
          ...
          >
            <svg class="scale-75" @click="handleModal" width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                class="cursor-pointer"
