...
// WORKING ON
export const createTreatmentPlan = async (name) => {
  console.log('creating new treatment plan: ', name)
  const result = await API.graphql({
    query: gql`
      mutation MyMutation {
        createTreatmentPlan(
...
export const createTask = async (patientId, type, priority, description) => {
  console.log('create Task Endpoint called!: ', patientId, priority, type)
  const result = await API.graphql({
    query: gql`
...
export const getPatient = async (patientId) => {
  ...
  console.log('patient: ', result.data.getPatient)
...
//         {
//           "name": null,
//           "patientId": "cdbb7139-f075-40c0-b5af-91d6bcfeee9b",
//           "subAccounts": null
//         },
//         {
//           "name": null,
//           "patientId": "a4eba3f4-795f-4697-94d3-89d8cb435874",
//           "subAccounts": null
//         },
//         {
//           "name": null,
//           "patientId": "c02bda73-a40c-4c0f-80b6-7a6fa1768425",
//           "subAccounts": null
//         }
//       ]
//     }
...
export const updateInsurance = async (patientId, groupNumber, memberId, insuranceName, policyHolderName) => {
  ...
  return result.data.updateInsuranceInfo.patientProfile.healthInsurance
}
