...
// PROVIDER **********************************************************************
// NEEED TO TEST
export const getProviderPay = async (providerId) => {
  const result = await API.graphql({
    query: gql`
      query MyQuery($providerId: String!) {
        getProviderPay(providerId: $providerId)
      }
    `,
    variables: {
      name: providerId,
...
// TODO: Here is the base query to get the notes by patient
// query MyQuery {
//   getNotesByPatient(patientId: "014750b8-fc6b-4238-9be5-26a2026bfcc1") {
//     nextToken
//     notes {
//       text
//       patientId
...
//TODO: Here is the base query to create a new message for the patient
// mutation MyMutation {
//   createNote(newNote: {patientId: "014750b8-fc6b-4238-9be5-26a2026bfcc1", text: "Good work on your treatment plan things are looking good", type: "patient"}) {
//     creatorRole
//     type
//     text
//   }
