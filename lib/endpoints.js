...
export const getPatient = async (patientId) => {
  ...
  console.log('GetPatient: ', result.data.getPatient.patientProfile)
  return result.data.getPatient
}

// WORKING On
export const updatePatient = async (patientId, patientFirstName, patientLastName, patientWeight, patientHeight, patientDOB, patientSex, patientAddress) => {
  const result = await API.graphql({
    query: gql`
      mutation MyMutation(
        $patientId: String
